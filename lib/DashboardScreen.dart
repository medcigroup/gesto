        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            PopupMenuButton<String>(
              onSelected: (value) async { // Ajoutez async
                if (value == 'logout') {
                  try {
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.pushNamed(context, AppRoutes.RoomsPages);
                },
              ),
              ListTile(
                leading: const Icon(Icons.restaurant),
                title: const Text('Restaurant'), // ou 'Commandes' ou 'Menu'
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                title: const Text('Clients'), // ou 'Invités' ou 'Profils clients'
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                title: const Text('Personnel'), // ou 'Gestion du personnel'
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                title: const Text('Finances'), // ou 'Comptabilité' ou 'Revenus'
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                title: const Text('Statistiques'), // ou 'Rapports' ou 'Performances'
                onTap: () {
                  Navigator.pop(context);
                },
              ),
              ListTile(
                ...
                title: const Text('Paramètres'), // ou 'Configuration'
                onTap: () {
                  Navigator.pop(context);
                },
              ),
